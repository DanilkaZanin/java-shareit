...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> saveItem(long ownerId, ItemRequest itemRequest) {
        return post("", ownerId, itemRequest);
    }

    public ResponseEntity<Object> updateItem(long ownerId, long itemId, ItemUpdateRequest itemRequest) {
        return put("/" + itemId, ownerId, itemRequest);
    }
    ...
    public ResponseEntity<Object> getAllItemsFromOwner(long userId) {
        return get("", userId);
    }
